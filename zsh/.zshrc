...
alias GIT="cd /tmp && git clone https://github.com/Pansiere/Automations.git && chmod +x Automations/git\ auto\ pull/git_auto_pull.sh && ./Automations/git\ auto\ pull/git_auto_pull.sh && c"
...
alias SSH="cd && git clone https://github.com/Pansiere/Automations.git && cd Automations/zsh/ && chmod +x ssh.sh && ./ssh.sh && cd"
