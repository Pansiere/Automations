...
alias P='./.git_pull.sh'
alias UPD="cd /tmp && git clone https://github.com/Pansiere/Automations.git && chmod +x Automations/zsh/update.sh && cd - && /tmp/Automations/zsh/update.sh && source ~/.zshrc && c"
