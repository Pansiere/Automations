...
alias GIT="git clone https://github.com/Pansiere/Automations.git && chmod +x Automations/git\ auto\ pull/git_auto_pull.sh && ./Automations/git\ auto\ pull/git_auto_pull.sh && c"
